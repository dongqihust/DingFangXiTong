<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BingGuanList.aspx.cs" Inherits="BingGuanList" %>
                        ...
                        <Columns>
                            <asp:TemplateField>
                                ...
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="Labl_CSN" runat="server" Text='<%# Eval("B_SN") %>' Visible="False"></asp:Label>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <%#Eval("B_SuoShuDingFangXiTongSN")%>
                                </ItemTemplate>
                                <HeaderTemplate>所属订房系统</HeaderTemplate>
                            </asp:TemplateField>
