<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FangXingList.aspx.cs" Inherits="FangXingList" %>
                    ...
                    <asp:GridView ID="Griw_List" runat="server" AutoGenerateColumns="False" GridLines="None" CssClass="table table-bordered table-hover">
                        ...
                        <asp:TemplateField>
                            ...
                            <asp:TemplateField>
                                ...
                                <HeaderTemplate>房型名称</HeaderTemplate>
                            </asp:TemplateField>
