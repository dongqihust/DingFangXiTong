...
var s = ["Texx_XianXiaFaShengDiDianSheng", "Texx_XianXiaFaShengDiDianShi", "Texx_XianXiaFaShengDiDianXianQu"];
//var opt0 = ["省份", "地级市", "市、县级市、县"];
var opt0 = ["请选择省", "请选择市", "请选择区县"];//初始化默认值
function setup() {
    for (i = 0; i < s.length - 1; i++)
        document.getElementById(s[i]).onchange = new Function("change(" + (i + 1) + ");promptinfo();getTown();");
    change(0);
}
...
function promptinfo() {
    ...
    var Texx_XianXiaFaShengDiDianSheng = document.getElementById('Texx_XianXiaFaShengDiDianSheng');
    var Texx_XianXiaFaShengDiDianShi = document.getElementById('Texx_XianXiaFaShengDiDianShi');
    var town1 = document.getElementById('town1');
}
//获取区县的值（若不写这个触发函数，一直获取不到第三项区县的值，一直是默认值“请选择区县”）
function getTown() {
 
    var Texx_XianXiaFaShengDiDianSheng = document.getElementById('Texx_XianXiaFaShengDiDianSheng').value
    var Texx_XianXiaFaShengDiDianShi = document.getElementById('Texx_XianXiaFaShengDiDianShi').value;
    var Texx_XianXiaFaShengDiDianXianQu = document.getElementById('Texx_XianXiaFaShengDiDianXianQu').value;
